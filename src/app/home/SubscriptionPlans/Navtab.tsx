...
import { Box, Button, MantineProvider, MantineTheme, Text } from "@mantine/core";
    ...
    <>
      <MantineProvider theme={primaryButtonTheme}>
        <Box component="div" className="grid place-items-center">
          <Text component="ul"  style={()=>{
          return{
            backgroundColor: colorScheme === "dark" ? `rgba(255, 255, 255, 0.1)` : `white`
          }
        }} p={5} className="flex items-center justify-center gap-2 shadow-sm rounded-[100vmax]">
            <Text component="li">
