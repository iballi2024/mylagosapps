  ...
  return (
    <>
      ...
      <div className="flex flex-col md:flex-row items-stretch h-screen">
        <div className="hidden md:block col-span-12 md:basis-[48%] bg-dark-9/60">A</div>
        <div className="col-span-12 md:basis-[52%] flex flex-col place-content-center items-center">{children}</div>
      </div>
    </>
  );
}
